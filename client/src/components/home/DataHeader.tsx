        ...
        <div ref={headerRef} className={`${isSticky ? 'w-full spaceX fixed top-0 left-0' : ''}`}>
            <div className={`w-full h-fit px-2 md:px-4 bg-primary dark:bg-dark-primary border-b border-secondary dark:border-dark-secondary`}>
                <div className="w-full min-h-[8vh] grid grid-cols-6 md:grid-cols-10 lg:grid-cols-14 items-center">
                    <span className="data__header hidden md:block">#</span>
                    <span className="data__header col-span-2">Name</span>
                    <span className="data__header col-span-2">Price</span>
                    <span className="data__header">1h %</span>
                    <span className="data__header">24h %</span>
                    <span className="data__header hidden md:block">7d %</span>
                    <span className="data__header hidden lg:block col-span-2">Mkt Cap</span>
